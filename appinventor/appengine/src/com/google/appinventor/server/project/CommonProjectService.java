...
public abstract class CommonProjectService {
   ...
   */
  public abstract RpcResult sendToNewGallery(String userId, long projectId);

  /**
   * loadFromNewGallery -- Load a project from the new gallery
   *
   * @param userId the userId to load the project into
   * @param galleryId the unique gallery ID for this project
   */

  public abstract UserProject loadFromNewGallery(String userId, String galleryId) throws IOException;
