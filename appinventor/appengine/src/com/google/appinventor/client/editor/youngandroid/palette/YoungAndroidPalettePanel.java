...
import static com.google.appinventor.client.youngandroid.YoungAndroidFormUpgrader.COMPONENT_DATABASE;
...
public class YoungAndroidPalettePanel extends AbstractPalettePanel<SimpleComponentDatabase, YaFormEditor> {
  ...
  public YoungAndroidPalettePanel(YaFormEditor editor) {
    super(editor, new YoungAndroidComponentFactory(editor), ComponentCategory.USERINTERFACE,
        ComponentCategory.LAYOUT, ComponentCategory.MEDIA, ComponentCategory.ANIMATION, ComponentCategory.MAPS,
        ComponentCategory.SENSORS, ComponentCategory.SOCIAL, ComponentCategory.STORAGE,
        ComponentCategory.CONNECTIVITY, ComponentCategory.LEGOMINDSTORMS, ComponentCategory.EXPERIMENTAL,
        ComponentCategory.EXTENSION, ComponentCategory.INTERNAL);
