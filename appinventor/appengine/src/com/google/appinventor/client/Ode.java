...
public class Ode implements EntryPoint {
  ...
  private void openProject(String projectIdString) {
    if (projectIdString.equals("")) {
      ...
      if (project != null && !project.isInTrash()) {   // If last opened project is now in the trash, don't open it.
        ...
        projectManager.loadProjects(projectService).then(projects -> {
  ...
  public void onModuleLoad() {
    ...
    Promise.<Config>call(MESSAGES.serverUnavailable(),
        ...
        .then(this::handleGalleryId)
        .then(this::checkTos)
        .then(this::loadUserSettings)
        .then(this::loadTranslations)  // translation based on user setting last locale
        .then(ignored -> Promise.allOf(
        ...
        .then(this::retrieveTemplateData)
        .then(this::maybeOpenLastProject)
        .error(caught -> {
          if (caught == null) {
  ...
  private Promise<Object> handleGalleryId(Object ignored) {
  ...
  private Promise<Object> checkTos(Object ignored) {
  ...
  private Promise<UserSettings> loadUserSettings(Object ignored) {
  ...
  private Promise<Object> retrieveTemplateData(Object ignored) {
  ...
  private Promise<Object> maybeOpenLastProject(Object ignored) {
  ...
  private Promise<Boolean> loadTranslations(Object ignored) {
