...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Login to New Gallery")
  @Description("Text for the \"Login to New Gallery\" Button")
  String loginToNewGallery();

  @DefaultMessage("Send to New Gallery")
  @Description("Text for the \"Send to New Gallery\" Button")
  String sendToNewGallery();
