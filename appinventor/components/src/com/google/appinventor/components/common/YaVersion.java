...
public class YaVersion {
  ...
  // - ACCELEROMETERSENSOR_COMPONENT_VERSION was incremented to 5
  // - BALL_COMPONENT_VERSION was incremented to 7
  // - BUTTON_COMPONENT_VERSION was incremented to 7
  // - CANVAS_COMPONENT_VERSION was incremented to 14
  // - DATEPICKER_COMPONENT_VERSION was incremented to 4
  // - FORM_COMPONENT_VERSION was incremented to 28
  // - HORIZONTALALIGNMENT_COMPONENT_VERSION was incremented to 4
  // - HORIZONTALSCROLLARRANGEMENT_COMPONENT_VERSION was incremented to 2
  // - IMAGE_COMPONENT_VERSION was incremented to 5
  // - IMAGESPRITE_COMPONENT_VERSION was incremented to 7
  // - MAP_COMPONENT_VERSION was incremented to 6
  // - MARKER_COMPONENT_VERSION was incremented to 4
  // - NAVIGATION_COMPONENT_VERSION was incremented to 2
  // - NXT_DIRECT_COMMANDS_COMPONENT_VERSION was incremented to 2
  // - EV3_COLORSENSOR_COMPONENT_VERSION was incremented to 2
  // - EV3_GYROSENSOR_COMPONENT_VERSION was incremented to 2
  // - EV3_ULTRASONICSENSOR_COMPONENT_VERSION was incremented to 2
  // - SOUND_COMPONENT_VERSION was incremented to 4
  // - TEXTING_COMPONENT_VERSION was incremented to 5
  // - TIMEPICKER_COMPONENT_VERSION was incremented to 4
  // - VERTICALARRANGEMENT_COMPONENT_VERSION was incremented to 4
  // - VERTICALSCROLLARRANGEMENT_COMPONENT_VERSION was incremented to 2
  // - VIDEOPLAYER_COMPONENT_VERSION was incremented to 7
  ...
  public static final String PREFERRED_COMPANION = "2.60t3";
  ...
  public static final String [] ACCEPTABLE_COMPANIONS = { "2.60t3", "2.60t3u" };
